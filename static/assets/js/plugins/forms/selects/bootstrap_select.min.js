            ...
            constructor: e, init: function () {
                ...
                this.$newElement.on("touchstart.dropdown", ".dropdown-menu", function (a) {
                    ...
                    b.setSize(), b.$element.on("shown.bs.select", function () {
                        ...
                        } else b.$menu.find(".active a").focus()
                    })
                    ...
                    if (b.multiple && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !d.parent().hasClass("disabled")) {
                        ...
                        if (b.multiple) {
                            if (i.prop("selected", !j), b.setSelected(e, !j), d.blur(), l !== !1 || m !== !1) {
                                ...
                                if (l && n || m && o)if (l && 1 == l)h.prop("selected", !1), i.prop("selected", !0), b.$menu.find(".active").removeClass("active"), b.setSelected(e, !0); else if (m && 1 == m) {
                                    k.find("option:selected").prop("selected", !1), i.prop("selected", !0);
                                    var p = d.parent().data("optgroup");
                                    b.$menu.find('[data-optgroup="' + p + '"]').removeClass("active"), b.setSelected(e, !0)
                                } else {
                        ...
                        } else h.prop("selected", !1), i.prop("selected", !0), b.$menu.find(".active").removeClass("active"), b.setSelected(e, !0);
                ...
                this.$newElement.on("click.dropdown.data-api touchstart.dropdown.data-api", function () {
                    d.$menuInner.find(".active").removeClass("active"), d.$searchbox.val() && (d.$searchbox.val(""), d.$lis.not(".is-hidden").removeClass("hidden"), e.parent().length && e.remove()), d.multiple || d.$menuInner.find(".active").addClass("active"), setTimeout(function () {
                        d.$searchbox.focus()
                    }, 10)
                ...
                this.findLis(), this.$element.find("option:enabled").not("[data-divider], [data-hidden]").prop("selected", !0), this.$lis.not(".divider, .dropdown-header, .disabled, .hidden").addClass("active"), this.render(!1)
            }, deselectAll: function () {
                this.findLis(), this.$element.find("option:enabled").not("[data-divider], [data-hidden]").prop("selected", !1), this.$lis.not(".divider, .dropdown-header, .disabled, .hidden").removeClass("active"), this.render(!1)
            }, keydown: function (c) {
