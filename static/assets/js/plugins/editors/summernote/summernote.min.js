!function (a) {
    ...
    var z = function () {
        ...
        var b = function (a, b) {
            ...
            picture: function (a) {
                return c("icon-image2", {event: "showImageDialog", title: a.image.image, hide: !0})
            }, link: function (a) {
                return c("icon-link", {event: "showLinkDialog", title: a.link.link, hide: !0})
            }, table: function (a) {
                ...
                return c("icon-table2", {title: a.table.table, dropdown: b})
            }, style: function (a, b) {
                ...
                var c = '<i class="icon-text-color" style="color:black;background-color:yellow;"></i>', d = b(c, {
                ...
                return c("icon-bold2", {event: "bold", title: a.font.bold})
            }, italic: function (a) {
                return c("icon-italic2", {event: "italic", title: a.font.italic})
            }, underline: function (a) {
                return c("icon-underline2", {event: "underline", title: a.font.underline})
            }, clear: function (a) {
                return c("icon-font", {event: "removeFormat", title: a.font.clear})
            }, ul: function (a) {
                return c("icon-list", {event: "insertUnorderedList", title: a.lists.unordered})
            }, ol: function (a) {
                return c("icon-list-numbered", {event: "insertOrderedList", title: a.lists.ordered})
            }, paragraph: function (a) {
                var b = c("icon-paragraph-left3", {
                    title: a.paragraph.left,
                    event: "justifyLeft"
                }), d = c("icon-paragraph-center3", {
                    title: a.paragraph.center,
                    event: "justifyCenter"
                }), e = c("icon-paragraph-right3", {
                    title: a.paragraph.right,
                    event: "justifyRight"
                }), f = c("icon-paragraph-justify3", {
                    title: a.paragraph.justify,
                    event: "justifyFull"
                }), g = c("icon-indent-decrease2", {
                    title: a.paragraph.outdent,
                    event: "outdent"
                }), h = c("icon-indent-increase2", {
                ...
                return c("icon-paragraph-left3", {title: a.paragraph.paragraph, dropdown: i})
            }, height: function (a, b) {
                ...
                return c("icon-text-height", {
                    title: a.font.height,
                    dropdown: '<ul class="dropdown-menu">' + d + "</ul>"
                })
            }, help: function (a) {
                return c("icon-help", {event: "showHelpDialog", title: a.options.help, hide: !0})
            }, fullscreen: function (a) {
                return c("icon-screen-full", {event: "fullscreen", title: a.options.fullscreen})
            }, codeview: function (a) {
                return c("icon-embed", {event: "codeview", title: a.options.codeview})
            }, undo: function (a) {
                return c("icon-undo", {event: "undo", title: a.history.undo})
            }, redo: function (a) {
                return c("icon-redo", {event: "redo", title: a.history.redo})
            }, hr: function (a) {
                return c("icon-minus2", {event: "insertHorizontalRule", title: a.hr.insert})
            }
        }, i = function (a, e) {
            var f = function () {
                var b = c("icon-pencil3", {
                    title: a.link.edit,
                ...
                var e = b('<span class="note-fontsize-10">100%</span>', {
                    ...
                    event: "resize",
                    value: "0.25"
                }), h = c("icon-paragraph-left3", {
                    title: a.image.floatLeft,
                    event: "floatMe",
                    value: "left"
                }), i = c("icon-paragraph-right3", {
                    title: a.image.floatRight,
                    event: "floatMe",
                    value: "right"
                }), j = c("icon-paragraph-justify3", {
                    title: a.image.floatNone,
                    event: "floatMe",
                    value: "none"
                }), k = c("icon-radio-unchecked", {
                    title: a.image.shapeRounded,
                    event: "imageShape",
                    value: "img-rounded"
                }), l = c("icon-radio-checked", {
