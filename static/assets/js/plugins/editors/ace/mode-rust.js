        ...
        this.$rules = {
            start: [{
                ...
                push: [{
                    ...
                    regex: "'",
                    next: "pop"
                }, {include: "#rust_escaped_character"}, {defaultToken: "string.quoted.single.source.rust"}]
            }, {
                ...
                push: [{
                    ...
                    regex: '"',
                    next: "pop"
                }, {include: "#rust_escaped_character"}, {defaultToken: "string.quoted.double.source.rust"}]
            }, {
