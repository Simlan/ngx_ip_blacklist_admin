...
(function (e) {
    ...
    m = function (e, t) {
        ...
        return e.prototype.rewrite = function (e) {
            ...
            for (n = i = 0, s = r.length; 0 <= s ? i < s : i > s; n = 0 <= s ? ++i : --i) {
                while (this.tag(t + n + e) === "HErecommend")e += 2;
            ...
            return e = [], this.scanTokens(function (t, n, r) {
                ...
                if (!y() || H !== "IF" && H !== "TRY" && H !== "FINALLY" && H !== "CATCH" && H !== "CLASS" && H !== "SWITCH") {
                    ...
                    if (H === ":") {
                        ...
                        while (this.tag(C - 2) === "HErecommend")C -= 2;
    ...
    et = e("./rewriter"), F = et.Rewriter, w = et.INVERSES, tt = e("./helpers"), V = tt.count, Y = tt.starts, X = tt.compact, K = tt.last, G = tt.repeat, $ = tt.invertLiterate, Q = tt.locationDataToString, Z = tt.throwSyntaxError, t.Lexer = k = function () {
        ...
        return e.prototype.tokenize = function (e, t) {
            ...
            var e, t, n;
            return (n = this.chunk.match(l)) ? (e = n[0], t = n[1], t && this.token("HErecommend", this.sanitizeHeredoc(t, {
                herecommend: !0,
