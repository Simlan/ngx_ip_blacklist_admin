    ...
    return b.axis = function (c, d, e, f, g, h) {
        this.chart = c, this.position = d, this.categoryFields = null === g || void 0 === g ? e : [].concat(g), this.measure = f, this.timeField = g, this.floatingBarWidth = 5, this.hidden = !1, this.showPercent = !1, this.colors = null, this.overrideMin = null, this.overrideMax = null, this.shapes = null, this.showGridlines = null, this.gridlineShapes = null, this.titleShape = null, this.dateParseFormat = null, this.tickFormat = null, this.timePeriod = null, this.timeInterval = 1, this.useLog = !1, this.logBase = 10, this.title = void 0, this.clamp = !0, this.ticks = null, this.fontSize = "10px", this.fontFamily = "sans-serif", this.autoRotateLabel = null === h || void 0 === h ? !0 : h, this._slaves = [], this._scale = null, this._min = 0, this._max = 0, this._previousOrigin = null, this._origin = null, this._orderRules = [], this._groupOrderRules = [], this._draw = null, this._getAxisData = function () {
            ...
            return null !== this.tickFormat && void 0 !== this.tickFormat ? b = this._hasTimeField() ? a.time.format(this.tickFormat) : a.format(this.tickFormat) : this.showPercent ? b = a.format("%") : this.useLog && null !== this.measure ? b = function (b) {
                var c = Math.floor(Math.abs(b), 0).toString().length, d = Math.min(Math.floor((c - 1) / 3), 4), e = "kmBT".substring(d - 1, d), f = "0" === Math.round(b / Math.pow(1e3, d) * 10).toString().slice(-1) ? 0 : 1;
        ...
        this.svg = c, this.x = "10%", this.y = "10%", this.width = "80%", this.height = "80%", this.data = d, this.noFormats = !1, this.axes = [], this.series = [], this.legends = [], this.storyboard = null, this.titleShape = null, this.shapes = null, this.ease = "cubic-in-out", this.staggerDraw = !1, this._group = c.append("g"), this._tooltipGroup = null, this._assignedColors = {}, this._assignedClasses = {}, this._nextColor = 0, this._nextClass = 0, this._axisIndex = function (a, b) {
            ...
            }, q = {x: !1, y: !1, z: !1, p: !1, c: !1}, r = {x: [], y: []}, s = {
                x: [],
                y: [],
                z: [],
                p: []
            }, t = {min: null, max: null}, u = {x: [], y: [], z: [], p: []}, v = [], w = {}, x = {
                x: 0,
                y: 0,
                z: 0,
                p: 0
        ...
        stacked: !0, grouped: !0, supportedAxes: ["x", "y", "c"], draw: function (c, d, e) {
            var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C = d._positionData, D = [], E = null, F = "dimple-series-" + c.series.indexOf(d), G = d.x._hasCategories() || d.y._hasCategories() ? 0 : 1, H = !1, I = {}, J = [], K = [], L = function () {
            ...
            for (f = "step" === d.interpolation ? "step-after" : d.interpolation, o = b._getSeriesOrder(d.data || c.data, d), d.c && (d.x._hasCategories() && d.y._hasMeasure() || d.y._hasCategories() && d.x._hasMeasure()) && (H = !0), d.x._hasCategories() ? (A = "x", B = "y") : d.y._hasCategories() && (A = "y", B = "x"), g = 0; g < C.length; g += 1) {
                for (j = [], l = -1, i = G; i < C[g].aggField.length; i += 1)j.push(C[g].aggField[i]);
                for (k = b._createClass(j), i = 0; i < D.length; i += 1)if (D[i].keyString === k) {
                    l = i;
                    break
                }
                -1 === l && (l = D.length, D.push({
                    key: j,
                    keyString: k,
                    color: "white",
                    data: [],
                    ...
                    entry: {},
                    exit: {},
                    group: A && C[g][A + "Field"] && C[g][A + "Field"].length >= 2 ? C[g][A + "Field"][0] : "All"
                })), D[l].data.push(C[g])
            }
            for (o && D.sort(function (a, c) {
                return b._arrayIndexCompare(o, a.key, c.key)
            }), g = 0; g < D.length; g += 1) {
                for (D[g].data.sort(b._getSeriesSortPredicate(c, d, o)), h = 0; h < D[g].data.length; h += 1)D[g].points.push({
                    x: O("x", D[g].data[h]),
                    y: O("y", D[g].data[h])
                }), A && (I[D[g].group] || (I[D[g].group] = {}), I[D[g].group][D[g].points[D[g].points.length - 1][A]] = d[B]._origin);
                p = D[g].points, "step" === d.interpolation && p.length > 1 && A && (d.x._hasCategories() ? (p.push({
                    x: 2 * p[p.length - 1].x - p[p.length - 2].x,
                    y: p[p.length - 1].y
                }), I[D[g].group][p[p.length - 1][A]] = d[B]._origin) : d.y._hasCategories() && (p = [{
                    x: p[0].x,
                    y: 2 * p[0].y - p[1].y
                }].concat(p), I[D[g].group][p[0][A]] = d[B]._origin, D[g].points = p))
            }
            ...
            null !== c._tooltipGroup && void 0 !== c._tooltipGroup && c._tooltipGroup.remove(), E = null === d.shapes || void 0 === d.shapes ? c._group.selectAll("." + F).data(D) : d.shapes.data(D, function (a) {
                ...
                c.noFormats || this.attr("opacity", function (a) {
                    ...
                    return H ? "url(#" + b._createClass(["fill-area-gradient-" + a.keyString]) + ")" : a.color.fill
                }).style("stroke", function (a) {
                    return H ? "url(#" + b._createClass(["stroke-area-gradient-" + a.keyString]) + ")" : a.color.stroke
                }).style("stroke-width", d.lineWeight)
            }).each(function (a) {
                a.markerData = a.data, N(a, this)
            }), m = c._handleTransition(E, e, c).attr("d", function (a) {
                return a.update
            }).each(function (a) {
                a.markerData = a.data, N(a, this)
            }), n = c._handleTransition(E.exit(), e, c).attr("d", function (a) {
                return a.exit
            }).each(function (a) {
                a.markerData = [], N(a, this)
            }), b._postDrawHandling(d, m, n, e), d.shapes = E
        }
    }, b.plot.bar = {
        ...
        stacked: !1, grouped: !0, supportedAxes: ["x", "y", "c"], draw: function (c, d, e) {
            ...
            for (o && q.sort(function (a, c) {
                ...
                }].concat(q[g].points))), q && q[g] && q[g].points && 1 === q[g].points.length && q[g].points.push({
                    x: q[g].points[0].x,
                    y: q[g].points[0].y
                }), q[g].entry = z(f, "_previousOrigin")(q[g].points), q[g].update = z(f)(q[g].points), q[g].exit = z(f, "_origin")(q[g].points), q[g].color = c.getColor(q[g].key.length > 0 ? q[g].key[q[g].key.length - 1] : "All"), q[g].css = c.getClass(q[g].key.length > 0 ? q[g].key[q[g].key.length - 1] : "All")
            }
        ...
        var i = [].concat(a), j = f.svg.select("#" + b._createClass([c])), k = [], l = d.position + "Field", m = !0, n = [];
